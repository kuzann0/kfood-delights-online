async function handleVerification(userId, status) {
    try {
        // Find verification item and its modal container
        ...
        try {
            ...
            if (data.success) {
                // Safely remove the item with animation
                if (verificationItem) {
                    // First fade out
                    ...
                    setTimeout(() => {
                        try {
                            if (verificationItem.parentElement) {
                                verificationItem.parentElement.removeChild(verificationItem);
                            }
                            
                            // Update remaining items count and UI
                            ...
                            console.error('Error removing verification item:', removeError);
                        }
                    }, 300);
                }
            } else {
